...
program ShengBTE
  ...
  do Tcounter=1,CEILING((T_max-T_min)/T_step)+1
	 ...
	 ! considering the el_ph couplings
	 ! Modified by WuYu 2022/9/21
     rate_scatt=rate_scatt+rate_scatt_isotope+rate_scatt_4ph + epw_sr
     ...
     if(myid.eq.0) then
		...
		do ll = 1,Nlist
			do i1=1,nbands
			   do i2=1,nbands
			       if(i1 /= i2) then
				       write(734,"(2E20.10,2E20.10,9E14.5)") energy(ll,i1),energy(ll,i2),ThConductivityMode_g(ll,i1,i2,:,:)
				   end if
			   end do
			end do
		end do
